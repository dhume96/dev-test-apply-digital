...
export class ProductService {
    ...
    async createOrUpdateProduct(body: CreateProductInput): Promise<ProductPayload | null> {
    ...
    async listProducts(input: ProductListInputDto): Promise<PaginationPayload> {
        ...
        const Products = await this.ProductModel.find(where).skip(skip).limit(limit);
